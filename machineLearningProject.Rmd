...
From this the Quadratic Discriminant Analysis (QDA) method shows the highest accuracy at nearly 90%.  From this the predicitons of the testing set are made.  These are then to be saved to files and uploaded to coursera.  From this all 20 data points were correctly predicted.
